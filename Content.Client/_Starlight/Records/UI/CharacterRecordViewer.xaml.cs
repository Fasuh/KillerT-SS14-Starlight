...
using FullCharacterRecords = Content.Shared._Starlight.Records.FullCharacterRecords;
using PlayerProvidedCharacterRecords = Content.Shared._Starlight.Records.PlayerProvidedCharacterRecords;

namespace Content.Client._Starlight.Records.UI;
