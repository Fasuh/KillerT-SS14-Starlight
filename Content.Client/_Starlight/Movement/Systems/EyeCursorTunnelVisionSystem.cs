...
namespace Content.Client._Starlight.Movement.Systems;

public sealed partial class EyeCursorTunnelVisionSystem : EntitySystem
{
    ...
    // This value is here to make sure the user doesn't have to move their cursor
    ...
    public override void Initialize()
    {
        ...
        // Add your additional initialization for EyeCursorTunnelVisionSystem here
    }
